 ...
 * @author UCU
 */
public class FormBajaProductos extends javax.swing.JFrame {
    Farmacia ucus;
    
    /**
     * Creates new form FormProductos
     */
    public FormBajaProductos(Farmacia pharm) {
        initComponents();
        this.ucus = pharm;
    }
    
    public FormBajaProductos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Baja"));
        jPanel1.setPreferredSize(new java.awt.Dimension(458, 200));
        ...
        jLabel5.setText("Nombre de área");
        ...
        if(jRadioButton1.isSelected()){
            try{
                if(jTextField4.getText() != null){
                    ...
                    String result = ucus.eliminarProd(codigo);
        ...
        if(jRadioButton2.isSelected()){
            try{
                if(jTextField5.getText() != null){
                    ...
                    String result = ucus.eliminarArea(area);
                    JOptionPane.showMessageDialog(null, result);
                }
                else{
                    throw new NullNodeException("El campo es obligatorio.");
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBajaProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBajaProductos().setVisible(true);
            }
        });
    }
